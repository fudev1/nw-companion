...
# class NewWorldCharacter(BaseProfile):
...
#     active_set = models.ForeignKey('GearSet', on_delete=models.SET_NULL, null=True, blank=True)
...
#     character = models.ForeignKey(NewWorldCharacter, on_delete=models.CASCADE, related_name='roles')
#     classe = models.ForeignKey('Role', limit_choices_to={'type': 'game'} ,on_delete=models.CASCADE, null=True, blank=True)
